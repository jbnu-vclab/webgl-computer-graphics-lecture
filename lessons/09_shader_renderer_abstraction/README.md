...
`http://localhost:8080/lessons/_current/contents.html`(또는 `http://localhost:8080/lessons/9_shader_renderer_abstraction/contents.html`)에 접속해 보시면 uniform에 설정한 파란색으로 사각형이 표시되는 것을 보실 수 있습니다.
